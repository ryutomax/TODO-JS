...
var createIncompleteList = function createIncompleteList(text) {
  ...
  li.className = "list-row"; // <p></p> 生成

  var p = document.createElement("p"); //pタグ内に入力値が設定された状態で出力

  p.innerText = text; // 完了button生成
  ...
  completeButton.addEventListener("click", function () {
    ...
    var addTarget = completeButton.parentNode; //最初の子要素(TODO内)のテキストを取得

    var text = addTarget.firstElementChild.innerText; // li以下を初期化

    addTarget.textContent = null; //　pタグ生成

    var p = document.createElement("p");
    p.innerText = text; // 戻るbutton生成
  ...
  li.appendChild(deleteButton); // 未完了リストに追加
